...
def test_one():
    detector = NanoDetONNX('/content/card_nanodet_m-1.5x-416.onnx', input_shape=[416,416])
    img = cv2.imread('/content/binz19.jpg')
